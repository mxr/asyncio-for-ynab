# asyncio_for_ynab.MoneyMovementsApi
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    api_instance = asyncio_for_ynab.MoneyMovementsApi(api_client)
    ...
    try:
        # Get all money movement groups
        api_response = await api_instance.get_money_movement_groups(plan_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get money movement groups for a plan month
        api_response = await api_instance.get_money_movement_groups_by_month(plan_id, month)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all money movements
        api_response = await api_instance.get_money_movements(plan_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get money movements for a plan month
        api_response = await api_instance.get_money_movements_by_month(plan_id, month)
