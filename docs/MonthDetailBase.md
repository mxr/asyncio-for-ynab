...
**categories** | [**List[CategoryBase]**](CategoryBase.md) | The plan month categories.  Amounts (budgeted, activity, balance, etc.) are specific to the {month} parameter specified. | 
