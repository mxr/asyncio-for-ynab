...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    api_instance = asyncio_for_ynab.AccountsApi(api_client)
    ...
    data = asyncio_for_ynab.PostAccountWrapper() # PostAccountWrapper | The account to create.

    try:
        # Create an account
        api_response = await api_instance.create_account(plan_id, data)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an account
        api_response = await api_instance.get_account_by_id(plan_id, account_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all accounts
        api_response = await api_instance.get_accounts(plan_id, last_knowledge_of_server=last_knowledge_of_server)
