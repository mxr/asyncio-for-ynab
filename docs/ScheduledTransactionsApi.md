# asyncio_for_ynab.ScheduledTransactionsApi
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    api_instance = asyncio_for_ynab.ScheduledTransactionsApi(api_client)
    ...
    data = asyncio_for_ynab.PostScheduledTransactionWrapper() # PostScheduledTransactionWrapper | The scheduled transaction to create

    try:
        # Create a scheduled transaction
        api_response = await api_instance.create_scheduled_transaction(plan_id, data)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a scheduled transaction
        api_response = await api_instance.delete_scheduled_transaction(plan_id, scheduled_transaction_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a scheduled transaction
        api_response = await api_instance.get_scheduled_transaction_by_id(plan_id, scheduled_transaction_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all scheduled transactions
        api_response = await api_instance.get_scheduled_transactions(plan_id, last_knowledge_of_server=last_knowledge_of_server)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    plan_id = 'plan_id_example' # str | The id of the plan. \"last-used\" can be used to specify the last used plan and \"default\" can be used if default plan selection is enabled (see: https://api.ynab.com/#oauth-default-plan).
    scheduled_transaction_id = 'scheduled_transaction_id_example' # str | The id of the scheduled transaction
    put_scheduled_transaction_wrapper = asyncio_for_ynab.PutScheduledTransactionWrapper() # PutScheduledTransactionWrapper | The scheduled transaction to update

    try:
        # Update a scheduled transaction
        api_response = await api_instance.update_scheduled_transaction(plan_id, scheduled_transaction_id, put_scheduled_transaction_wrapper)
