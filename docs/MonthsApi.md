...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    api_instance = asyncio_for_ynab.MonthsApi(api_client)
    ...
    try:
        # Get a plan month
        api_response = await api_instance.get_plan_month(plan_id, month)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all plan months
        api_response = await api_instance.get_plan_months(plan_id, last_knowledge_of_server=last_knowledge_of_server)
