# asyncio_for_ynab.PayeeLocationsApi
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    api_instance = asyncio_for_ynab.PayeeLocationsApi(api_client)
    ...
    try:
        # Get a payee location
        api_response = await api_instance.get_payee_location_by_id(plan_id, payee_location_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all payee locations
        api_response = await api_instance.get_payee_locations(plan_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all locations for a payee
        api_response = await api_instance.get_payee_locations_by_payee(plan_id, payee_id)
