...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    api_instance = asyncio_for_ynab.PlansApi(api_client)
    ...
    try:
        # Get a plan
        api_response = await api_instance.get_plan_by_id(plan_id, last_knowledge_of_server=last_knowledge_of_server)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get plan settings
        api_response = await api_instance.get_plan_settings_by_id(plan_id)
...
async with asyncio_for_ynab.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all plans
        api_response = await api_instance.get_plans(include_accounts=include_accounts)
