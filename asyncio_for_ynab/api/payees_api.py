...
class PayeesApi:
    ...
    async def create_payee(
        ...
        data: Annotated[PostPayeeWrapper, Field(description="The payee to create")],
        ...
        :type plan_id: str
        :param data: The payee to create (required)
        :type data: PostPayeeWrapper
        ...
        _param = self._create_payee_serialize(
            plan_id=plan_id,
            data=data,
    ...
    @validate_call
    async def create_payee_with_http_info(
        self,
        plan_id: Annotated[StrictStr, Field(description="The id of the plan. \"last-used\" can be used to specify the last used plan and \"default\" can be used if default plan selection is enabled (see: https://api.ynab.com/#oauth-default-plan).")],
        data: Annotated[PostPayeeWrapper, Field(description="The payee to create")],
        _request_timeout: Union[
    ...
    @validate_call
    async def create_payee_without_preload_content(
        self,
        plan_id: Annotated[StrictStr, Field(description="The id of the plan. \"last-used\" can be used to specify the last used plan and \"default\" can be used if default plan selection is enabled (see: https://api.ynab.com/#oauth-default-plan).")],
        data: Annotated[PostPayeeWrapper, Field(description="The payee to create")],
        _request_timeout: Union[
    ...
    def _create_payee_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/plans/{plan_id}/payees',
    ...
    def _get_payee_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/plans/{plan_id}/payees/{payee_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
