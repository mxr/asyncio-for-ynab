...
from asyncio_for_ynab.api_client import ApiClient, RequestSerialized
from asyncio_for_ynab.api_response import ApiResponse
from asyncio_for_ynab.rest import RESTResponseType
...
class TransactionsApi:
    ...
    def _create_transaction_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/plans/{plan_id}/transactions',
    ...
    def _delete_transaction_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/plans/{plan_id}/transactions/{transaction_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_transactions(
        self,
        plan_id: Annotated[StrictStr, Field(description="The id of the plan. \"last-used\" can be used to specify the last used plan and \"default\" can be used if default plan selection is enabled (see: https://api.ynab.com/#oauth-default-plan).")],
        since_date: Annotated[Optional[date], Field(description="If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30). Defaults to one year ago when not specified.")] = None,
        until_date: Annotated[Optional[date], Field(description="If specified, only transactions on or before this date will be included.  The date should be ISO formatted (e.g. 2016-12-30).")] = None,
        ...
        :param plan_id: The id of the plan. \"last-used\" can be used to specify the last used plan and \"default\" can be used if default plan selection is enabled (see: https://api.ynab.com/#oauth-default-plan). (required)
        :type plan_id: str
        :param since_date: If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30). Defaults to one year ago when not specified.
        :type since_date: date
        :param until_date: If specified, only transactions on or before this date will be included.  The date should be ISO formatted (e.g. 2016-12-30).
    ...
    def _get_transactions_serialize(
        ...
        if until_date is not None:
            if isinstance(until_date, date):
                ...
                _query_params.append(('until_date', until_date))
    ...
    def _get_transactions_by_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/plans/{plan_id}/accounts/{account_id}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_transactions_by_category_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/plans/{plan_id}/categories/{category_id}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_transactions_by_month(
        self,
        plan_id: Annotated[StrictStr, Field(description="The id of the plan. \"last-used\" can be used to specify the last used plan and \"default\" can be used if default plan selection is enabled (see: https://api.ynab.com/#oauth-default-plan).")],
        month: Annotated[StrictStr, Field(description="The plan month in ISO format (e.g. 2016-12-01) (\"current\" can also be used to specify the current calendar month (UTC))")],
    ...
    def _get_transactions_by_month_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/plans/{plan_id}/months/{month}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_transactions_by_payee_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/plans/{plan_id}/payees/{payee_id}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _import_transactions_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/plans/{plan_id}/transactions/import',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
