...
class SubTransaction(BaseModel):
    ...
    transfer_account_id: Optional[UUID] = Field(default=None, description="If a transfer, the account_id which the subtransaction transfers to")
    ...
    amount_formatted: Optional[StrictStr] = Field(default=None, description="The subtransaction amount formatted in the plan's currency format")
    amount_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The subtransaction amount as a decimal currency amount")
    __properties: ClassVar[List[str]] = ["id", "transaction_id", "amount", "memo", "payee_id", "payee_name", "category_id", "category_name", "transfer_account_id", "transfer_transaction_id", "deleted", "amount_formatted", "amount_currency"]
