...
class PlanDetail(BaseModel):
    ...
    id: UUID
    name: StrictStr
    last_modified_on: Optional[datetime] = Field(default=None, description="The last time any changes were made to the plan from either a web or mobile client")
    first_month: Optional[date] = Field(default=None, description="The earliest plan month")
    last_month: Optional[date] = Field(default=None, description="The latest plan month")
    ...
    months: Optional[List[MonthDetailBase]] = None
    transactions: Optional[List[TransactionSummaryBase]] = None
    subtransactions: Optional[List[SubTransactionBase]] = None
    scheduled_transactions: Optional[List[ScheduledTransactionSummaryBase]] = None
    scheduled_subtransactions: Optional[List[ScheduledSubTransactionBase]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "categories": [CategoryBase.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            "months": [MonthDetailBase.from_dict(_item) for _item in obj["months"]] if obj.get("months") is not None else None,
            "transactions": [TransactionSummaryBase.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
            "subtransactions": [SubTransactionBase.from_dict(_item) for _item in obj["subtransactions"]] if obj.get("subtransactions") is not None else None,
            "scheduled_transactions": [ScheduledTransactionSummaryBase.from_dict(_item) for _item in obj["scheduled_transactions"]] if obj.get("scheduled_transactions") is not None else None,
            "scheduled_subtransactions": [ScheduledSubTransactionBase.from_dict(_item) for _item in obj["scheduled_subtransactions"]] if obj.get("scheduled_subtransactions") is not None else None
        })
        return _obj
