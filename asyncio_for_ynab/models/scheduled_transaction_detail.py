...
class ScheduledTransactionDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "date_first", "date_next", "frequency", "amount", "memo", "flag_color", "flag_name", "account_id", "payee_id", "category_id", "transfer_account_id", "deleted", "amount_formatted", "amount_currency", "account_name", "payee_name", "category_name", "subtransactions"]
