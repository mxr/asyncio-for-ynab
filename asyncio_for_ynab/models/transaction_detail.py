...
class TransactionDetail(BaseModel):
    ...
    transfer_account_id: Optional[UUID] = Field(default=None, description="If a transfer transaction, the account to which it transfers")
    ...
    amount_formatted: Optional[StrictStr] = Field(default=None, description="The transaction amount formatted in the plan's currency format")
    amount_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The transaction amount as a decimal currency amount")
