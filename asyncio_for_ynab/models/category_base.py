...
class CategoryBase(BaseModel):
    ...
    internal: StrictBool = Field(description="Whether or not the category is internal")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if goal_snoozed_at (nullable) is None
        # and model_fields_set contains the field
        if self.goal_snoozed_at is None and "goal_snoozed_at" in self.model_fields_set:
            _dict['goal_snoozed_at'] = None
