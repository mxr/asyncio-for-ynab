...
class SaveCategoryGroupResponseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category_group", "server_knowledge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of category_group
        if self.category_group:
            _dict['category_group'] = self.category_group.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category_group": CategoryGroup.from_dict(obj["category_group"]) if obj.get("category_group") is not None else None,
